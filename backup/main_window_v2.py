...
if hasattr(Qt.ApplicationAttribute, 'AA_EnableHighDpiScaling'):
    ...
    Qt.QApplication.setAttribute(Qt.ApplicationAttribute.AA_EnableHighDpiScaling, True)

if hasattr(Qt.ApplicationAttribute, 'AA_UseHighDpiPixmaps'):

    Qt.QApplication.setAttribute(Qt.ApplicationAttribute.AA_UseHighDpiPixmaps, True)
